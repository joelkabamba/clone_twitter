        ...
        <template #header>
            <div class="flex items-center justify-between">
                ...
                <div v-if="profileUser.id != $page.user.id">
                    <inertia-link v-if="!profileUser.is_followed" as="button" method="POST" :href="`/follows/${profileUser.id}`" class="bg-white text-blue-500 cursor-pointer px-5 py-2 
        ...
        <div class="py-12">
            <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
                <div v-for="tweet in tweets" v-bind:key="tweet.id" class="flex items-center space-x-4 bg-white overflow-hidden rounded rounded-b-one border-b-2 border-gray-200 py-6 px-4">
                    <img :src="profileUser.profile_photo_url" alt="" class="h-16 w-16 object-cover rounded-full">
